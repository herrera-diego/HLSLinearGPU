...
port (
    ...
    midpoint_X0 : IN STD_LOGIC_VECTOR (31 downto 0);
    midpoint_Y0 : IN STD_LOGIC_VECTOR (31 downto 0);
    midpoint_X1 : IN STD_LOGIC_VECTOR (31 downto 0);
    midpoint_Y1 : IN STD_LOGIC_VECTOR (31 downto 0);
    midpoint_PX : OUT STD_LOGIC_VECTOR (31 downto 0);
    midpoint_PX_ap_vld : OUT STD_LOGIC;
    midpoint_PY : OUT STD_LOGIC_VECTOR (31 downto 0);
    midpoint_PY_ap_vld : OUT STD_LOGIC );
end;


architecture behav of midpoint_line is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "midpoint_line,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.404000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=226,HLS_SYN_LUT=513,HLS_VERSION=2018_2}";
    ...
    signal x1_reg_79 : STD_LOGIC_VECTOR (31 downto 0);
    signal y1_reg_88 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    x1_reg_79_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_3_fu_173_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    y1_reg_88_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_3_fu_173_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    dx_fu_97_p2 <= std_logic_vector(unsigned(midpoint_X1) - unsigned(midpoint_X0));
    dy_0_s_fu_199_p3 <= 
        dy_reg_247 when (tmp_6_fu_185_p3(0) = '1') else 
        tmp_2_reg_257;
    dy_fu_119_p2 <= std_logic_vector(unsigned(midpoint_Y1) - unsigned(midpoint_Y0));
    midpoint_PX <= std_logic_vector(unsigned(x1_reg_79) + unsigned(ap_const_lv32_1));

    midpoint_PX_ap_vld_assign_proc : process(ap_CS_fsm_state3, tmp_3_fu_173_p2)
    begin
        if (((tmp_3_fu_173_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    midpoint_PY <= 
        y1_reg_88 when (tmp_6_fu_185_p3(0) = '1') else 
        y_1_fu_193_p2;

    midpoint_PY_ap_vld_assign_proc : process(ap_CS_fsm_state3, tmp_3_fu_173_p2)
    begin
        if (((tmp_3_fu_173_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    tmp_3_fu_173_p2 <= "1" when (signed(x1_reg_79) < signed(midpoint_X1)) else "0";
    ...
    tmp_fu_154_p3 <= 
        ...
        tmp_4_fu_150_p1;
    x_1_fu_178_p2 <= std_logic_vector(unsigned(x1_reg_79) + unsigned(ap_const_lv32_1));
    y_0_s_fu_205_p3 <= 
        y1_reg_88 when (tmp_6_fu_185_p3(0) = '1') else 
        y_1_fu_193_p2;
    y_1_fu_193_p2 <= std_logic_vector(unsigned(y1_reg_88) + unsigned(ap_const_lv32_1));
end behav;
