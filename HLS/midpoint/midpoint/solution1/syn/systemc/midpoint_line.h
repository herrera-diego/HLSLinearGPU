...
#ifndef _midpoint_line_HH_
#define _midpoint_line_HH_
...
struct midpoint_line : public sc_module {
    ...
    sc_in< sc_lv<32> > midpoint_X0;
    sc_in< sc_lv<32> > midpoint_Y0;
    sc_in< sc_lv<32> > midpoint_X1;
    sc_in< sc_lv<32> > midpoint_Y1;
    sc_out< sc_lv<32> > midpoint_PX;
    sc_out< sc_logic > midpoint_PX_ap_vld;
    sc_out< sc_lv<32> > midpoint_PY;
    sc_out< sc_logic > midpoint_PY_ap_vld;


    // Module declarations
    midpoint_line(sc_module_name name);
    SC_HAS_PROCESS(midpoint_line);
    ...
    sc_signal< sc_lv<32> > x1_reg_79;
    sc_signal< sc_lv<32> > y1_reg_88;
    ...
    void thread_midpoint_PX();
    void thread_midpoint_PX_ap_vld();
    void thread_midpoint_PY();
    void thread_midpoint_PY_ap_vld();
