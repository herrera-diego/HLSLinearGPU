...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.dda.autotvin_x0.dat"
         "c.dda.autotvin_y0.dat"
         "c.dda.autotvin_x1.dat"
         "c.dda.autotvin_y1.dat"
         "c.dda.autotvout_xp.dat"
         "c.dda.autotvout_yp.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.dda.autotvout_xp.dat"
         "rtl.dda.autotvout_yp.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
