...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dda.autotvin.dat"
	set constFileTvOut       "dda.autotvout.dat"
	set constFileHdlTvIn     "dda.autohdltvin.dat"
	set constFileHdlTvOut    "dda.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
