...
#ifndef __dda_sitofp_32ns_3dEe__HH__
#define __dda_sitofp_32ns_3dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dda_sitofp_32ns_3dEe) {
    ...
    SC_CTOR(dda_sitofp_32ns_3dEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
