...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bresenham.autotvin.dat"
	set constFileTvOut       "bresenham.autotvout.dat"
	set constFileHdlTvIn     "bresenham.autohdltvin.dat"
	set constFileHdlTvOut    "bresenham.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
