...
if {[file isfile bresenham.autotvin.dat]} {
	file delete -force bresenham.autotvin.dat
}

if {[file isfile bresenham.autotvout.dat]} {
	file delete -force bresenham.autotvout.dat
}
