...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.bresenham.autotvin_x0.dat"
         "c.bresenham.autotvin_y0.dat"
         "c.bresenham.autotvin_x1.dat"
         "c.bresenham.autotvin_y1.dat"
         "c.bresenham.autotvout_xp.dat"
         "c.bresenham.autotvout_yp.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.bresenham.autotvout_xp.dat"
         "rtl.bresenham.autotvout_yp.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
