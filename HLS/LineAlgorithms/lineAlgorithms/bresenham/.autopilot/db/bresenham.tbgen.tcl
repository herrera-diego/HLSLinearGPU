set C_TypeInfoList {{ 
"bresenham" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"x0": [[], {"scalar": "int"}] }, {"y0": [[], {"scalar": "int"}] }, {"x1": [[], {"scalar": "int"}] }, {"y1": [[], {"scalar": "int"}] }, {"xp": [[],{ "pointer":  {"scalar": "int"}}] }, {"yp": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
set moduleName bresenham
