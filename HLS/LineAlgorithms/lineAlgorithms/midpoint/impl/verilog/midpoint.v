...
assign tmp_3_fu_173_p2 = (($signed(x_reg_79) < $signed(x1)) ? 1'b1 : 1'b0);
...
assign x_1_fu_178_p2 = (x_reg_79 + 32'd1);

assign xp = (x_reg_79 + 32'd1);

assign y_0_s_fu_205_p3 = ((tmp_6_fu_185_p3[0:0] === 1'b1) ? y_reg_88 : y_1_fu_193_p2);

assign y_1_fu_193_p2 = (y_reg_88 + 32'd1);

assign yp = ((tmp_6_fu_185_p3[0:0] === 1'b1) ? y_reg_88 : y_1_fu_193_p2);
