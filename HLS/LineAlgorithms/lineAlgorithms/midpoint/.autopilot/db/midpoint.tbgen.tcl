set C_TypeInfoList {{ 
"midpoint" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"x0": [[], {"scalar": "int"}] }, {"y0": [[], {"scalar": "int"}] }, {"x1": [[], {"scalar": "int"}] }, {"y1": [[], {"scalar": "int"}] }, {"xp": [[],{ "pointer":  {"scalar": "int"}}] }, {"yp": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
set moduleName midpoint
...
set ArgLastReadFirstWriteLatency {
	midpoint {
		...
		y0 {Type I LastRead 1 FirstWrite -1}
		x1 {Type I LastRead 0 FirstWrite -1}
		y1 {Type I LastRead 1 FirstWrite -1}
		xp {Type O LastRead -1 FirstWrite 2}
		yp {Type O LastRead -1 FirstWrite 2}}}
