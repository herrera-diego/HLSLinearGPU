...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "midpoint.autotvin.dat"
	set constFileTvOut       "midpoint.autotvout.dat"
	set constFileHdlTvIn     "midpoint.autohdltvin.dat"
	set constFileHdlTvOut    "midpoint.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
