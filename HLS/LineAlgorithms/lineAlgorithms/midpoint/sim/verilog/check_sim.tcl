...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.midpoint.autotvin_x0.dat"
         "c.midpoint.autotvin_y0.dat"
         "c.midpoint.autotvin_x1.dat"
         "c.midpoint.autotvin_y1.dat"
         "c.midpoint.autotvout_xp.dat"
         "c.midpoint.autotvout_yp.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.midpoint.autotvout_xp.dat"
         "rtl.midpoint.autotvout_yp.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
