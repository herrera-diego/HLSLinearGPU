...
if {[file isfile midpoint.autotvin.dat]} {
	file delete -force midpoint.autotvin.dat
}

if {[file isfile midpoint.autotvout.dat]} {
	file delete -force midpoint.autotvout.dat
}
